      ...
      card(
        ...
        card_body(
          ...
          p("PRISM uses ", tags$strong("one"), " definition of a signal throughout: ",
            ...
            ". Results below are scored under that rule. The looser alternative it ",
            "was chosen over is available under ",
            tags$em("How this threshold was chosen"), "."),
          ...
          p(class = "text-muted",
            tags$strong("Reading the failures. "),
            "The two kinds are worth separating. A pair that fires in a ",
            tags$em("single"), " quarter out of forty is multiplicity \u2014 the ",
            "arithmetic above predicts it. A pair that fires in ten or more, like ",
            "esomeprazole and osteonecrosis of jaw, is not noise: PPIs and ",
            "bisphosphonates reach the same elderly and oncology populations, so the ",
            "disproportionality is real and reflects channelling rather than ",
            "pharmacology. No threshold removes that second kind, which is why ",
            "disproportionality output needs clinical review before it means anything."),
          p(class = "text-muted",
